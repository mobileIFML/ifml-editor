...
/**
 * This is the item provider adapter for a {@link IFML.Mobile.WiFi} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WiFiItemProvider extends NetworkItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WiFi_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WiFi_value_feature", "_UI_WiFi_type"),
				 MobilePackage.Literals.WI_FI__VALUE,
				 true,
				 false,
				 false,
