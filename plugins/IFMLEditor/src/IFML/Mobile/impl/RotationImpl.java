 ...
 * <ul>
 *   <li>{@link IFML.Mobile.impl.RotationImpl#isIsAvailable <em>Is Available</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class RotationImpl extends MobileContextVariableImpl implements Rotation {
	/**
	...
	protected EClass eStaticClass() {
		return MobilePackage.Literals.ROTATION;
	}
	...
	public void setIsAvailable(boolean newIsAvailable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobilePackage.ROTATION__IS_AVAILABLE, oldIsAvailable, isAvailable));
	}
