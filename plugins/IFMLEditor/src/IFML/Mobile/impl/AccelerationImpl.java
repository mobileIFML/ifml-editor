 ...
 * <ul>
 *   <li>{@link IFML.Mobile.impl.AccelerationImpl#isIsAvailable <em>Is Available</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AccelerationImpl extends MobileContextVariableImpl implements Acceleration {
	/**
	...
	protected EClass eStaticClass() {
		return MobilePackage.Literals.ACCELERATION;
	}
	...
	public void setIsAvailable(boolean newIsAvailable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobilePackage.ACCELERATION__IS_AVAILABLE, oldIsAvailable, isAvailable));
	}
